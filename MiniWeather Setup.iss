...
; Generated by Chris Woodhouse on 03/02/2021 (UTC)
;
[Setup]
AppID={{b605d64a-a724-4c62-8695-e494995017f8}
AppName=ASCOM MiniWeather ObservingConditions Driver
AppVerName=ASCOM MiniWeather ObservingConditions Driver 2.4
AppVersion=2.2
AppPublisher=Chris Woodhouse <chris@digitalastrophotography.co.uk>
AppPublisherURL=mailto:chris@digitalastrophotography.co.uk
...
OutputDir="."
OutputBaseFilename="MiniWeather Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\ObservingConditions\MiniWeather"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\ObservingConditions\MiniWeather"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "E:\Visual Studio\Project files\Gizmo\MiniWeatherASCOM\MiniWeather\bin\Release\ASCOM.MiniWeather.ObservingConditions.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "E:\Visual Studio\Project files\Gizmo\MiniWeatherASCOM\MiniWeather\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.MiniWeather.ObservingConditions.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.MiniWeather.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.MiniWeather.ObservingConditions.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.MiniWeather.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.MiniWeather.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
